...
def contact_us(request):
    return render(request, 'stores/templates/navs/home/contact_us.html')


# terms and condition static page
def terms_and_conditions(request):
    return render(request, 'stores/templates/navs/home/terms_and_conditions.html')


# shipping policy static page 
def shipping_policy(request):
    return render(request, 'stores/templates/navs/home/shipping_policy.html')


# privacy policy static page
def privacy_policy(request):
    return render(request, 'stores/templates/navs/home/privacy_policy.html')


# cancel refund static page
def cancel_refund(request):
    return render(request, 'stores/templates/navs/home/cancel_refund.html')