...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('username', 'name', 'email', 'phone', 'is_superuser', 'outdoor_token', 'channel_name', 'bot_token', 'razorpay_clientid', 'razorpay_clientsecret', 'gst_number', 'firebase_token')
